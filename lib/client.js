  ...
  },
  {
    ...
    "tokens": {
      ...
      "--shiki-token-changed": "#fab387"
		...
		/**
		 * Update-check row: a manual "check for updates" button hitting the
		 * host's /catppuccin/check-update route (npm registry, 5-min cache),
		 * showing the current/latest versions and the copyable upgrade
		 * command when a newer release exists.
		 */
