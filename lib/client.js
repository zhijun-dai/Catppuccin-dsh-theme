		...
		function apply(ctx) {
			...
			const SURFACE_RULES = [
				...
				[
					...
					[
						"  background-image: radial-gradient(1500px 950px at 6% -14%, color-mix(in srgb, var(--dsw-alias-brand-primary) 7%, transparent), transparent 55%),",
						"    radial-gradient(1250px 850px at 106% 22%, color-mix(in srgb, var(--dsw-ctp-sky) 6%, transparent), transparent 55%),",
						"    radial-gradient(1150px 750px at 48% 122%, color-mix(in srgb, var(--dsw-ctp-peach) 5%, transparent), transparent 55%);"
					].join("\n")
				],
				[
					"[data-dsh-glow=\"on\"] [class$=\"uV2eYG_primary\"]:hover",
					"  box-shadow: 0 0 18px 2px color-mix(in srgb, var(--dsw-alias-brand-primary) 45%, transparent);"
				],
				[
					"[data-dsh-glow=\"on\"] [class$=\"uV2eYG_card\"]:hover",
					"  box-shadow: 0 0 16px 0 color-mix(in srgb, var(--dsw-alias-brand-primary) 26%, transparent);"
				],
				[
					"[data-dsh-glow=\"on\"] [class$=\"_userStack\"] [class$=\"_bubble\"]",
					"  box-shadow: 0 0 12px 0 color-mix(in srgb, var(--dsw-alias-brand-primary) 12%, transparent);"
				],
			...
			// Apply the pastel-glow layer state at boot (the settings row's
			// GlowRow reads the same storage).
